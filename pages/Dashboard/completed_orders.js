            ...
            <div className="panel-header bg-primary-gradient">
                <div className="page-inner py-5">
                    <div className="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                        <div>
                            <h2 className="text-white pb-2 fw-bold">Dashboard / Complete Orders</h2>
...
CompletedOrders.getInitialProps = async (context) => {
    const csrfToken = await getCsrfToken(context);
    const fetch_orders_url = process.env.BACKEND_URL+'/completeorder';
...
CompletedOrders.layout = "dashboardLayout"
